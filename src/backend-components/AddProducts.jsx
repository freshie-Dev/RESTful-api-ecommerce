...
function AddProductForm() {
    ...
    const postProduct = async() => {
        try {
            ...
            //     stock: product.stock,
            //     ratings: {
            //         stars: product.ratings.stars, reviews: product.ratings.reviews
            //     }
            // });
    ...
    return (
        <div>
            ...
            <input onChange={handleChange} placeholder='category' type="text" name='category' value={product.category} />
